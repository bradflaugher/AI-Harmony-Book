...
Talk about facial recognition, you can only recognize faces you've seen. hard to get by plastic surgery or fancy makeup.
...
If the past is not like the future, you are doing transfer learning. Most models steal data from other sources so are doing transfer learning too. This is fine, but do we know that we are doing this? Talk about finance and past performance and future results. 
