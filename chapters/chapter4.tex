...
%TODO add to myths section
%\hyperref[sec:multi]{Multicolinearity}
%\hyperref[sec:creative]{Creative or Critical}
%\hyperref[sec:explain]{Explainability}
%\hyperref[sec:limits]{Limitations}
%\hyperref[sec:plag]{Plagiarism}
%\hyperref[sec:drift]{Concept Drift}
%\hyperref[sec:janitor]{Data Janitoring and Editorializing}
%Performance/Cost
...
There are a few common myths or misunderstandings about the Shakespearean Text Generator. One myth is that the model can perfectly recreate Shakespeare's writing, when in reality it can only generate text that is similar in style. It's a great \hyperref[sec:creative]{creative tool} but that's about it.
\end{itemize}
...
\begin{marginfigure}[-5.5cm]
        \includegraphics{stockcharts}
        \caption{"mdjrny-v4 many stock price charts on top of each other with buy and sell signals" made with Mann-E}
        \labfig{stockcharts}
\end{marginfigure}
