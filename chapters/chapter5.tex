...
\begin{itemize}
    ...
    \item \textbf{Cost to Create:} \$0
    \item \textbf{Stealability:} This model is not stealable because it is not a model that can be trained on data. It is a tool that can be used to train other models.
    \item \textbf{Detectability:} This model is detectable because it is not a model that can be trained on data. It is a tool that can be used to train other models.
\end{itemize}
