...
\title[ A billion or so parameters. ]{ A billion or so parameters. }
...
\dedication{
	...
	-- Seymour A. Papert \cite{Papert1993}
	\newline
}
...
\addpart{History: the slow march away from algorithms towards layered statistical representations} % The slow drift away from algorithms
\pagelayout{margin} % Restore margins

\input{chapters/history.tex} % Deep Blue Brute Force, Machine Translation, Economic Models. 
\input{chapters/data_types.tex} 
\input{chapters/learning_types.tex} 

\pagelayout{wide} % No margins
\addpart{The Chaotic Prediction Machine: statistical inference with a billion or so parameters} 
\pagelayout{margin} % Restore margins
...
\input{chapters/ensembles_and_chaos.tex} 
