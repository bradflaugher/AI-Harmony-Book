...
\title[ Full Self-Driving, Skynet and other AI Myths ]{ Full Self-Driving Skynet and Other AI Myths }
...
\addpart{Understanding modern AI} % The slow drift away from algorithms
...
\pagelayout{wide} % No margins
\addpart{The Chaotic Prediction Machine} 
\pagelayout{margin} % Restore margins

\input{chapters/ensembles_and_chaos.tex} 
\input{chapters/ethics_and_errors.tex} 
\input{chapters/flavors_of_disruption.tex} 
